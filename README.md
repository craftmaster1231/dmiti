...
**В этом, собственно, и заключаются задачи многокритериальной оптимизации.**

### Следующая версия программы будет уметь производить все эти оптимизации.

Новая версия и примеры ее работы выложенны позже. На этом теоретическая часть закончена.
